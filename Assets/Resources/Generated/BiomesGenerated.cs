...
{
    public static readonly NativeInstanceData data0 = new NativeInstanceData(new float2(0.9500f, 1.0000f), new float3x2(new float3(1.0000f, 1.0000f, 1.0000f), new float3(1.2000f, 3.0000f, 1.2000f)), 5.9000f, 7, true);
	public static readonly NativeInstanceData data1 = new NativeInstanceData(new float2(0.9500f, 1.0000f), new float3x2(new float3(1.0000f, 1.0000f, 1.0000f), new float3(1.2000f, 3.0000f, 1.2000f)), 2.3000f, 7, true);

...
public class TerraxelGenerated
{
    ...
    public static float GenerateDensity(float2 pos2D){
        return (DensityGenerator.SurfaceNoise2D(pos2D + new float2(0.0000f,DensityGenerator.SurfaceNoise2D(pos2D + new float2(457.0000f,700.0000f), 24.0000f, 0.0050f,2, 3.0000f, 0.5000f)), 48.0000f, 0.0020f,4, 3.0000f, 0.3000f) + DensityGenerator.SurfaceNoise2D(pos2D + new float2(DensityGenerator.SurfaceNoise2D(pos2D + new float2(1.0000f,1.0000f), 24.0000f, 0.0070f,2, 2.0000f, 0.8000f),0.0000f), 24.0000f, 0.0020f,2, 3.0000f, 0.3000f));
    }
}